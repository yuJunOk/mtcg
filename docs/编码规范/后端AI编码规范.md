...
| 迭代 | 设计文档 |
| --- | --- |
| 迭代一 | [03-详细设计-迭代一](./设计文档/03-详细设计-迭代一-用户系统与用户管理.md) |
| 迭代二 | [04-详细设计-迭代二](./设计文档/04-详细设计-迭代二-卡牌与产品管理.md) |
| 迭代三 | [05-详细设计-迭代三](./设计文档/05-详细设计-迭代三-卡组构筑与卡牌收藏.md) |
| 迭代四 | [06-详细设计-迭代四](./设计文档/06-详细设计-迭代四-引擎状态模型与回合流程.md) |
| 迭代四 | [07-详细设计-迭代四](./设计文档/07-详细设计-迭代四-引擎行动与战斗.md) |
| 迭代五 | [08-详细设计-迭代五](./设计文档/08-详细设计-迭代五-对战API与对局持久化.md) |
| 迭代六 | [09-详细设计-迭代六](./设计文档/09-详细设计-迭代六-效果系统与关键词能力.md) |
| 迭代七 | [10-详细设计-迭代七](./设计文档/10-详细设计-迭代七-AI对战.md) |
| 迭代八 | [11-详细设计-迭代八](./设计文档/11-详细设计-迭代八-排位系统与打牌习惯分析.md) |
| 迭代九 | [12-详细设计-迭代九](./设计文档/12-详细设计-迭代九-系统管理.md) |

实现步骤指南：
- [13-实现步骤-迭代一](./设计文档/13-实现步骤-迭代一-用户系统与用户管理.md)
