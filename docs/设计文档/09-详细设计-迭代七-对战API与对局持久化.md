> **迭代规划调整说明（2026-08-03）**：本文档原对应旧迭代七，按 MVP 优先原则重新规划后，对应【新迭代五】。详见 [需求分析 §6](./01-需求分析.md#6-需求优先级与迭代规划)。文件名保留历史编号不变。
>
> ---
...
> 版本：v0.1
> 日期：2026-07-31
> 依据：[需求分析](./01-需求分析.md) FR4.1–FR4.5、FR5.4、FR5.6；[概要设计](./02-概要设计.md) §3 §5 §6；[迭代四](./06-详细设计-迭代四-引擎状态模型与回合流程.md)、[迭代五](./07-详细设计-迭代五-引擎行动与战斗.md)、[迭代六](./08-详细设计-迭代六-效果系统与关键词能力.md) 引擎产物
