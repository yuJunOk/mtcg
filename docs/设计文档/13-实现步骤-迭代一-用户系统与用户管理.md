...
2. 重写 `init.sql`：一次性建立 `mtcg_user`、`mtcg_card`、`mtcg_product` 三张表 + CHECK 约束 + update_time 触发器 + 默认管理员
...
**init.sql**：见详细设计 [§2.1](./03-详细设计-迭代一-用户系统与用户管理.md#21-建表sql三张表一次建完)，四张表 + 触发器 + 默认管理员一次建完。
...
1. 新建枚举（`com.aris.mtcg.common.enums`）：
   ...
   - `EnumCardType`、`EnumColor`、`EnumRarity` — 迭代二用，本迭代顺便建好；产品（卡包）由 `mtcg_product` 表管理（迭代二）
...
代码详见详细设计 [§3 枚举](./03-详细设计-迭代一-用户系统与用户管理.md#3-枚举设计)、[§4 实体类](./03-详细设计-迭代一-用户系统与用户管理.md#4-实体类设计)、[§5 DAO](./03-详细设计-迭代一-用户系统与用户管理.md#5-dao-层设计)。
...
代码详见详细设计 [§6 Manager 层](./03-详细设计-迭代一-用户系统与用户管理.md#6-manager-层设计jwt)。
...
代码详见详细设计 [§7 Service 层](./03-详细设计-迭代一-用户系统与用户管理.md#7-service-层设计)。
...
代码详见详细设计 [§9 拦截器与鉴权](./03-详细设计-迭代一-用户系统与用户管理.md#9-拦截器与鉴权设计)。
...
代码详见详细设计 [§8 Controller 层](./03-详细设计-迭代一-用户系统与用户管理.md#8-controller-层设计)。
...
| 6 | ~~`EnumProductType.java`~~（已移除，产品由 `mtcg_product` 表管理） | `common/enums` | — |
