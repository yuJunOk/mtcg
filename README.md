...
| 模块 | 说明 | 状态 |
| --- | --- | --- |
| 用户系统 | 注册 / 登录 / JWT 鉴权 / RBAC 权限 / 用户管理 CRUD | ✅ 已完成（迭代一） |
| 卡牌数据管理 | 角色卡 / 冲击卡 / 产品 CRUD / 卡牌特征 / 条件查询 | ✅ 已完成（迭代二） |
| 卡组构筑 | 卡组创建 / 校验 / 收藏管理 / 导入导出 | 📋 设计完成（迭代三） |
...
| 系统管理 | 系统配置 / 审计日志 / 体验增强（迭代十，审计已部分前置） | 📋 设计完成 |
...
| 迭代 | 阶段 | 范围 | 状态 |
| --- | --- | --- | --- |
| 迭代一 | 先能管 | 基础设施 + 用户系统（含用户管理） | ✅ 已完成 |
| 迭代二 | 先能管 | 卡牌与产品管理（含特征） | ✅ 已完成 |
